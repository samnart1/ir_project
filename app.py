"""
Streamlit Web UI for the Information Retrieval System.
...
def main():
    ...
    if query:
        # Create columns for each retriever
    ...
    st.markdown(
        ...
        <div style='text-align: center'>
            <p>Built for Information Retrieval Course | 
